...
// New card component that displays all content at once
const FeatureCard = ({ feature }) => {
  const { title, description, icon } = feature;

  return (
    <div className="feature-card p-6 rounded-2xl border border-base-300 hover:border-primary hover:shadow-md transition-all duration-200 mb-4">
