...
const StrategyPage = () => {
    ...
    const [hasValidStrategy, setHasValidStrategy] = useState(false);
            ...
            try {
                ...
                const validStrategy = !!(
                    ...
                    (
                        ...
                        data.profile.linkedinStrategy.foundation ||
                ...
                setHasValidStrategy(validStrategy);
    ...
    return (
        <div className="space-y-6 p-4 md:p-8 max-w-7xl mx-auto">
            {initialLoadComplete && hasValidStrategy ? (
                <>
                    <h1 className="text-3xl md:text-4xl font-extrabold text-base-content">
                        My LinkedIn Strategy
                    </h1>
                ...
                initialLoadComplete && (
                <div className="mx-auto max-w-3xl bg-base-100 rounded-lg p-6 md:p-8">
                    <h1 className="text-2xl font-bold text-center">Get Started With Your Strategy</h1>
