...
// --- Main Page Component ---
  ...
  //       calendarIndex: selectedCalendarIndex // Add the calendar index
  //     };
  ...
  //   }
  // };
  // In app/dashboard/profile/page.js
...
const savePost = async () => {
  ...
  // Now let's update the ContentCalendarTable component with the proper post checking logic:
                  ...
                  {selectedCalendar && (
                    <div className="relative">
                      ...
                      <div className="text-xs text-base-content/50 mb-2">
                        Selected Calendar Index: {selectedCalendarIndex} | 
                        Posts in this calendar: {selectedCalendar.posts?.length || 0}
                      </div>
                      
                      {/* // In your component */}

                      {/* // For the calendar table, make sure to render it even if no posts */}
